...
app = Flask(__name__)
model = tf.keras.models.load_model("D:/C Language/Plant-Disease-Recognition-System-main/Plant-Disease-Recognition-System-main/models/plant_disease_recog_model_pwp.keras")
